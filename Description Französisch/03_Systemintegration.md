...
Connexion CrediCONNECT à l’ERP / comptabilité pour la vérification de solvabilité | Connexion RiskCUBE à la boutique en ligne pour l’autorisation de l’achat sur facture | Solution de recouvrement pour une gestion optimisée des créances

## CrediCONNECT
https://www.creditreform.ch/loesungen/systemintegration/individuelle-anbindung
- La base de données économiques de la Suisse peut être connectée directement à des applications centrales telles que les systèmes ERP ou CRM.
...
- **Degré d’automatisation évolutif individuellement** : Des systèmes POS entièrement automatiques aux applications gérées manuellement.
...
- **Facilitation des processus :** lors de la création des données de base, de la vérification du risque et de la surveillance.
- **Projet d’implémentation rapide et économique.**
...
- **Lien entièrement automatisé des données de base** (débiteurs, créanciers ou partenaires commerciaux) avec les informations Creditreform. Nettoyage facile des données de base via les fonctions standard si nécessaire.
- **Intégration** dans le pool de paiement Creditreform Xchange.
...
- Communication chiffrée basée sur les standards web.
...
- Consultation par lot et traitement par lot (consultation en masse).
...
**2. Présentation en direct**  
Creditreform organise une web-conférence pour présenter les fonctionnalités en direct et clarifier les questions techniques.
...
- **Prix de location incl. maintenance logicielle (READY4 Credit Rating Bureaus)**  
  ...
  **6'000 euros par an**  
  *(autres périmètres comptables sur demande)*

- **Mise en service, personnalisation et formation**  
  **1'360 euros par jour** *(valeur indicative : env. 3-4 jours)*

- **Langues disponibles :** allemand, français (autres langues sur demande)

**Remarque :**  
Pour les membres disposant déjà du module, aucun coût de licence n’est facturé lors du passage au nouvel AddOn. Pour la reprise des données et la mise en service, un forfait de **5'000 euros** est appliqué.
...
**RiskCUBE** est une solution de Creditreform qui propose le mode de paiement « achat sur facture » dans les boutiques en ligne uniquement aux clients dont la solvabilité a été vérifiée et présentant un risque calculable. Grâce à un système de règles intelligent, les risques et tentatives de fraude sont détectés et minimisés. Les exploitants de boutiques peuvent ainsi intégrer en toute sécurité le mode de paiement « facture », ce qui conduit généralement à un taux de conversion plus élevé et à une augmentation du chiffre d’affaires.

> *« Avec ce module, nous pouvons désormais vendre sur facture dans la boutique en ligne. Depuis, notre chiffre d’affaires a augmenté de 30 %. » – Markus Roger Jenny, Directeur, deinKonzept GmbH, Uznach*

### Besoin

- La « facture » est le mode de paiement préféré en Suisse dans le commerce en ligne.
- Si ce mode de paiement n’est pas proposé, le risque d’abandon d’achat augmente.
- Sans vérification de solvabilité, il existe cependant des risques élevés de défaut de paiement.
- RiskCUBE doit garantir que seuls les clients disposant d’une solvabilité suffisante puissent utiliser l’achat sur facture.
...
1. **Vérification de solvabilité avant l’affichage des options de paiement**
   - Après la saisie des coordonnées dans le processus de commande, les données sont transmises à RiskCUBE.
...
2. **Paramétrages individuels**
   ...
   - Possibilité d’autoriser le mode de paiement « facture » en cas de solvabilité moyenne (jaune) ou de personne inconnue (pas de correspondance).
...
- **Comportement suspect dans la boutique** : En cas d’indicateurs de fraude (par ex. plusieurs commandes en peu de temps, adresse de livraison différente, etc.), le mode de paiement « facture » peut être désactivé.
- **Adresses postales invalides** : Pas d’option facture si l’adresse n’existe pas ou a déjà été signalée comme suspecte.
- **Restrictions basées sur le temps** : Blocage nocturne (pas d’achat sur facture entre 01h00 et 04h30).
...
### Possibilités de paramétrage (extrait)

- **Tolérance de correspondance** : Paramétrable pour autoriser, par exemple, de légères fautes de frappe dans les adresses.
...
- **Incidents de paiement** : Exclusion automatique de l’achat sur facture en cas d’incidents de paiement antérieurs.
...
3. **Signature du contrat et installation**
   ...
   - Vous recevez les identifiants d’accès, la documentation technique et d’autres détails pour la configuration de votre gestion des risques.
...
Un aperçu actuel de tous les plug-ins :  
...
- **Tarifs**
  ...
  - Vérification de solvabilité : offre individuelle par Creditreform (forfaits plus avantageux en cas de recouvrement supplémentaire ou de fourniture d’expériences de paiement)
...
- **Tarifs**
  ...
  - Vérification de solvabilité : offre individuelle (forfaits possibles, plus avantageux en cas de recouvrement supplémentaire ou de fourniture d’expériences de paiement)
...
- **Tarifs**
  ...
  - Vérification de solvabilité : offre individuelle (forfaits plus avantageux en cas de recouvrement supplémentaire ou de fourniture d’expériences de paiement)
...
- **Tarifs**
  ...
  - Vérification de solvabilité : offre individuelle (forfaits plus avantageux en cas de recouvrement supplémentaire ou d’expériences de paiement)
...
> *« Avec l’option supplémentaire pour AbaShop, la vérification de solvabilité est intégrée automatiquement dans la boutique. Cela fait gagner du temps et apporte de la sécurité. »  
– Bruno Rhomberg, membre de la direction, Creditreform Egeli Gruppe*

- **Paramétrage du risque avec gestion par feu de signalisation**
...
- **Paramétrages des modes de paiement** (exemples d’AbaShop) :
...
2. **Coûts du plug-in boutique**
   - Parfois mensuels, parfois uniques selon le système et le partenaire.

3. **Vérification de solvabilité**
   - Offres individuelles avec forfaits (plus avantageux en cas de recouvrement supplémentaire ou de fourniture d’expériences de paiement).

4. **Autres coûts**
   - Installation, maintenance, mise à jour ou support selon les indications des partenaires plug-in concernés.

*Tous les prix s’entendent hors taxe sur la valeur ajoutée (TVA).*
...
- **Interfaces intégrées à Creditreform pour :**
  ...
  - Surveillance des débiteurs (changements de nom et d’adresse, modifications de solvabilité, annonces de faillite)
