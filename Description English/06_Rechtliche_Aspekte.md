...
- The client (customer) and the credit agency are separate controllers under data protection law.
...
- The contractor acts exclusively according to contractually fixed instructions of the client.
- Examples:
  - Document destruction
  - Call center services
  - External mail delivery service providers
- No own decision-making or scope for action for the contractor.
...
- The debt collection service provider independently decides on measures (reminder letters, telephone reminders, legal action).
- Transfer of claim data from the creditor to the collection company is also not considered data processing on behalf.
- The collection company is an independent and responsible entity under data protection law.
...
- Anti-money laundering and matching with sanctions lists.
